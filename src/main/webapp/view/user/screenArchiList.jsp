...
<body>
<!-- Table Name: MT.Master_Screen_Archi  -->
	<div class="tableTitle">화면 레벨관리 정보 테이블</div>
	
	<table id="screenArchi" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>스크린 정보</th> <!-- screen_no -->
                <th>스크린 레벨계층 정보</th> <!-- Screen_Program_ID -->
                <th>삭제여부</th> <!-- del_cd  -->
    ...
    <script src="resources/js/user/dataTables4ScreenArchi.js"></script>
</body>
</html>