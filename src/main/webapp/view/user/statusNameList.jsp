...
<body>
<!-- Table Name: MT.Master_Status_Name_v2  -->
	<div class="tableTitle">사용자 상태정보 테이블 </div>
	
	<table id="statusName" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>상태코드</th> <!-- user_title_cd  -->
                <th>상태정보 설명</th> <!-- user_title_name  -->
                <th>삭제여부</th> <!-- del_cd  -->
    ...
    <script src="resources/js/user/dataTables4StatusName.js"></script>
</body>
</html>