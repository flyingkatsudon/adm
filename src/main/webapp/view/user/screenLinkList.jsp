...
<!-- Table Name: MT.Master_Screen_Archi  -->
	<div class="tableTitle">화면-세부권한 연결정보 테이블</div>
	
	<table id="screenLink" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th></th>
    ...
    <script src="resources/js/user/dataTables4ScreenLink.js"></script>
</body>
</html>