...
<body>
<!-- Table Name: MT.Master_Title_Name  -->
	<div class="tableTitle">직급정보 테이블 </div>
	
	<table id="titleName" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>직급코드</th> <!-- user_title_cd  -->
                <th>직급명</th> <!-- user_title_name  -->
                <th>삭제여부</th> <!-- del_cd  -->
    ...
    <script src="resources/js/user/dataTables4TitleName.js"></script>
</body>
</html>