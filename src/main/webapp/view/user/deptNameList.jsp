...
<!-- Table Name: MT.Master_Title_Name  -->
	<div class="tableTitle">부서정보 테이블 </div>
	
	<table id="deptName" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>부서코드</th> <!-- user_title_cd  -->
                <th>부서명</th> <!-- user_title_name  -->
                <th>삭제여부</th> <!-- del_cd  -->
    ...
    <script src="resources/js/user/dataTables4DeptName.js"></script>
</body>
</html>