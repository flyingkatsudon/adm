...
import com.bdp.adm.security.handler.LoginFailureHandler;
import com.bdp.adm.security.handler.LoginSuccessHandler;
import com.bdp.adm.util.CheckPwd;
import com.bdp.adm.vo.UserVO;

public class BDPAuthenticationFilter extends AbstractAuthenticationProcessingFilter {

	private static final Logger logger = LoggerFactory.getLogger(BDPAuthenticationFilter.class);
	...
	public BDPAuthenticationFilter() {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		logger.info("BDPAuthenticationFilter: {}", "attemptAuthentication");
		...
		BDPAuthenticationToken authRequest = new BDPAuthenticationToken(user);
	...
	protected void setDetails(HttpServletRequest request, BDPAuthenticationToken authRequest) {
