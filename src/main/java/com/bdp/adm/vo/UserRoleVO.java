...
public class UserRoleVO {
	...
	public int getOldUserRoleId() {
		return oldUserRoleId;
	}
	public void setOldUserRoleId(int oldUserRoleId) {
		this.oldUserRoleId = oldUserRoleId;
	}
