...
public class TrendKeywordsVO {
	
	@JsonProperty("DT_RowId")
	private String DTRowId;
	
	private int trendKeywordsIdx;
	...
	public int getTrendKeywordsIdx() {
		return trendKeywordsIdx;
	}
	public void setTrendKeywordsIdx(int trendKeywordsIdx) {
		this.trendKeywordsIdx = trendKeywordsIdx;
	}
