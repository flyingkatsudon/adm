...
<body>
<!-- Table Name: cboardd_demo.dashboard_user_role-->
	<div class="tableTitle">사용자-권한 연결정보 테이블 </div>
	
	<table id="userRole" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>인덱스</th> <!-- user_role_id  -->
                <th>사번</th> <!-- user_id  -->
                <th>권한명</th> <!-- role_id  -->
                <th>회사명</th> <!-- business_code  -->
                <th>삭제여부</th> <!-- business_code  -->                
                <th>적재일자</th> <!-- 6. load_date -->
                <th>적재시간</th> <!-- load_date -->
                <th>적재자명</th> <!-- load_date -->
    ...
    <script src="resources/js/user/dataTables4UserRole.js"></script>
</body>
</html>