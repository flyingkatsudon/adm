...
<body>
	<div class="tableTitle">트렌드 키워드 테이블</div>
	
	<table id="trendKeywords" class="display" cellspacing="0" width="100%">
        <thead>
            <tr>
                <th></th>
                <th>인덱스</th>
    ...
    <script src="resources/js/dict/dataTables4TrendKeywords.js"></script>
</body>
</html>